...
Original file is located at
    https://colab.research.google.com/drive/17Zfhi2EhEUI_mjdyHguPOAdF5-cYgm9L
"""
...
Original file is located at
    https://colab.research.google.com/drive/1yGx3y1h07K6wB597S59AgNii7TG-r51L
"""
...
total_training_samples = sampels - block_len + 1 # Account for sequence creation
# Calculate new batch size to get approximately 300 batches
...
def get_data():
    ...
    # Make sure to replace 'your_column_name' with the actual name of your time series column
    df = pd.read_csv('/content/drive/My Drive/fouling.csv')
    amplitude = df["Fouling factor (m2 K/kW)"].values
...
for current_input_window in input_windows_to_test:
    ...
    # Reload and process data with the new input window
    # Recalculate batch_size based on new input_window
    df = pd.read_csv('/content/drive/My Drive/fouling.csv')
    amplitude = df["Fouling factor (m2 K/kW)"].values
    sampels = int(len(amplitude) * train_size)
    ...
    for epoch in range(1, epochs + 1):
        ...
        if len(val_data) > 0:
            ...
            # evaluate(model, val_data) # evaluate is already called within plot_and_loss
            print('-' * 89)
